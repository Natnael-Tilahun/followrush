          ...
          {/* <span id="button-text " className=" "> */}
            {isLoading ? (
              // <div className="spinner" id="spinner">
                ...
                <svg role="status" className="text-center w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
